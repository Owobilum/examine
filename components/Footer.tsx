...
const Footer: FC = () => {
  return (
    <footer
      className="hidden bg-primary px-4 py-6 text-info font-primary md:px-10 lg:px-24
    md:py-12 md:block"
    >
      <div
        className=" bg-primary px-4 py-6 font-primary md:flex
   "
      >
        <div className="mb-4 md:mb-0 md:w-2/5 md:mr-2 lg:mr-12">
          <Image src="/icons/logo.svg" width="148px" height="33px" alt="logo" />
          <div className="flex flex-col gap-4 mt-8">
            <div className="text-lg font-medium md:text-3xl font-secondary  text-white">
            ...
            <div>
              ...
              placeholder:text-white placeholder:text-sm text-white md:pl-3"
                />
                <span
        ...
        <div className="md:w-1/5 md:flex md:flex-col md:gap-4">
          <h3 className="cursor-pointer text-white font-secondary w-fit h-fit font-medium md:text-2xl">
            About Us
          </h3>
      ...
      <div className="flex justify-between text-sm mt-12 text-info">
